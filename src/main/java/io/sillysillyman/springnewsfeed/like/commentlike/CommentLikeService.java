...
public class CommentLikeService {
    ...
    public HttpStatusResponseDto doLike(Long postId, Long commentId, Long userId) {
        ...
        if (userId.equals(comment.getUser().getId())) {
            return new HttpStatusResponseDto(ResponseCode.CANNOT_LIKE_MY_COMMENT);
        }

        User user = userRepository.findById(userId).orElse(null);
        commentLikeRepository.save(
            new CommentLike(new CommentLikeId(userId, commentId), user, comment));
    ...
    public HttpStatusResponseDto undoLike(Long postId, Long commentId, Long userId) {
        ...
        CommentLike commentLike = commentLikeRepository.findByIdUserIdAndIdCommentId(userId,
